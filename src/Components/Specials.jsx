...
const Specials = () => {
  const specials = [
    { id: 1, name: "Classic Ribeye Steak", price: "€30", image: "/src/assets/Photo1.png" },
    { id: 2, name: "Grilled Striploin Steak", price: "€28", image: "/src/assets/photo2.png" },
    { id: 3, name: "Herb Butter Sirloin", price: "€32", image: "/src/assets/photo3.png" },
  ];
