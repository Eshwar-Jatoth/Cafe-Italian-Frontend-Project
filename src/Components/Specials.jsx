...
const Specials = () => {
  const specials = [
    { id: 1, name: "Classic Ribeye Steak", price: "€30", image: Spc_photo1 },
    { id: 2, name: "Grilled Striploin Steak", price: "€28", image: Spc_photo2  },
    { id: 3, name: "Herb Butter Sirloin", price: "€32", image: Spc_photo3 },
  ];
